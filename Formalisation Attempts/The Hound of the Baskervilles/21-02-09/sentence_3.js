 ...
 *
 * Split version:
 *      - The stick was: fine; thick; wooden; and bulbous-headed.
 *      - The stick had a sort (type) of "Penang lawyer"
 */
...
function constraints_for_sentence_3(){
    let valid = false;
    //It was a fine, thick piece of wood, bulbous-headed, of the sort which is known as a “Penang lawyer.”
    let time = entities[0];
    for(let i = 0; i < time.objects.length; i++){
        let object = time.objects[i];
        if(object.name == "stick"){
            if(object.misc.includes("fine")){
                if(object.misc.includes("thick")){
                    if(object.misc.includes("wooden")){
                        if(object.misc.includes("bulbous-headed")){
                            if(object.type == "Penang lawyer"){
                                valid = true; 
                            }
                        }
                    }
